...
#Load to DataFrame and save to CSV
scraped = pd.DataFrame(brands_data)
scraped.to_csv('fashion.csv', index=False, encoding='utf-8-sig') #added 'utf-8-sig' parameter to fix misreading of csv file 
print('fashion.csv created!')